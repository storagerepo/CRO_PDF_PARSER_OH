...
public class InjuryConstants {
	...
	public static List<String> getInvalidInsurance() {
		...
		invalidInsurance.add("no proof");
		invalidInsurance.add("proof not shown");
		invalidInsurance.add("none, none");
		invalidInsurance.add("no insurance shown");
		invalidInsurance.add("none available");
		invalidInsurance.add("none given");
		invalidInsurance.add("none provided a");
		invalidInsurance.add("none provided");
		invalidInsurance.add("not provided");
		invalidInsurance.add("not showed");
		invalidInsurance.add("no");
